import { Component, OnInit, ChangeDetectionStrategy,ElementRef, Renderer2, ViewChild,AfterViewInit} from '@angular/core';
...
export class DashboardFirstComponent implements OnInit,AfterViewInit{
  /*捕获报文*/
  @ViewChild('tooHard',{static:true}) tooHard:ElementRef;
  myChartAapure:any;
  /*流量检测*/
...
/*  威胁等级堆叠图*/
 ...
 /* 获取报文数据*/
  AaptureMessageSet(){
    this.myChartAapure = echarts.init(this.tooHard.nativeElement);
 ...
 /* 获取检测流量数据*/
  DetectFlowSet(){
    this.myChartFlow = echarts.init(this.FlowOption.nativeElement);
...
/*  威胁等级堆叠柱状图*/
  getThrenOption(){
    this.myChartThrenOption = echarts.init(this.ThrenOption.nativeElement);
